...
public interface AuditCorrectiveActionRepository extends JpaRepository<AuditCorrectiveAction, Long>{
	...
	@Query(value = "SELECT a.CorrectiveActionId,a.AuditCheckListId,a.IqaId,a.CarRefNo,a.CarDescription,a.ActionPlan,a.Responsibility,a.TargetDate,b.ScheduleId,c.AuditeeId\r\n"
