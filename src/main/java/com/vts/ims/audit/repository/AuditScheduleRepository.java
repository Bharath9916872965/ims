...
public interface AuditScheduleRepository extends JpaRepository<AuditSchedule, Long> {
	...
	@Query(value="SELECT a.EmpId,a.AuditStatus,a.TransactionDate,a.Remarks,b.StatusName FROM ims_audit_trans a,ims_audit_status b WHERE a.ScheduleId = :scheduleId AND a.AuditStatus = b.AuditStatus AND a.AuditType = 'S' ORDER BY a.AuditScheduleTransactionId",nativeQuery = true)
